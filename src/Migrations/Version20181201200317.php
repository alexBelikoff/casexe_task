 ...
 */
final class Version20181201200317 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE lottery (id INT NOT NULL, start_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, active BOOLEAN DEFAULT NULL, cash_total INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE prize (id INT NOT NULL, lottery_id INT NOT NULL, user_id INT DEFAULT NULL, prize_type_id INT NOT NULL, prize_item_id INT DEFAULT NULL, prize_sum INT DEFAULT NULL, prize_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, send_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE security."user" (id INT NOT NULL, address_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, bank_account_num VARCHAR(64) NOT NULL, PRIMARY KEY(id))');
